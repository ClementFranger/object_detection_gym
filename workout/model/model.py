...
class Model(Source):
    ...
    def train(self, **kwargs):
        main_train = kwargs.get('main_train') or os.path.join(os.getenv('TENSORFLOW'), 'models', 'research', 'object_detection', 'model_main_tf2.py')
    ...
    def save(self, **kwargs):
        main_graph = kwargs.get('main_graph') or os.path.join(os.getenv('TENSORFLOW'), 'models', 'research', 'object_detection', 'exporter_main_v2.py')
